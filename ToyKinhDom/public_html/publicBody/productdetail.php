<?php
  ...
  $productdetail=$conn->selectsql("theloai,chitietsanpham,sanpham","*","where theloai.matheloai=chitietsanpham.matheloai  AND sanpham.masanpham = chitietsanpham.masanpham AND sanpham.masanpham='$_GET[id]'");
			...
			<div class="container-fliud">
				...
				<div class="wrapper row">
					...
					<div class="details col-md-6">
						...
						<h4 class="price">Giá tiền: <?php echo number_format($row['giaban'],0,',',',').'VNĐ'?></h4>
